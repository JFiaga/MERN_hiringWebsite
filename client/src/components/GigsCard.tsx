...
const GigsCard = (props: Props) => {
  return (
    <div className='text-black flex flex-col items-center space-y-4 w-[90%] sm:max-w-[350px] h-[600px] bg-white shadow-sm border border-black/10 rounded-md relative   overflow-hidden px-4 ml-4 mb-4 pb-5'>
      <div className='absolute w-[100px] h-[100px] rounded-full bg-primary top-[-5%] left-[-15%] '></div>
        ...
        <div className='flex w-full text-white font-semibold '>
          <button className='w-full bg-primary capitalize rounded-md py-3 transition-all duration-500 border hover:border-primary hover:bg-transparent hover:text-primary'>View Profile</button>
        </div>
