...
const MainHeader = (props: Props) => {
  ...
  return (
<div className={`${imgCaroussel[index].bg} flex items-center justify-center w-[100vw] transition-colors duration-500 overflow-hidden`}>
<div className={` px-4 pt-4 pb-12 md:pb-0 flex items-center justify-between sm:px-0 md:pt-16 md:justify-between md:space-x-8 ${imgCaroussel[index].bg} transition-all duration-500 max-w-[1400px]`}>
      <div className="flex flex-col w-[90%] space-y-5  md:max-w-[50%]">
        <h1 className="text-xl sm:text-2xl text-start">
          Recruter les meilleurs{" "}
          <span className="font-bold"> developpeurs Junior du marche</span>,
