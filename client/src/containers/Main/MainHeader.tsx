    ...
    <section className=" flex  w-[100vw] h-[900px] md:max-h-[900px] md:px-8 px-4 py-6 bg-primaryDark justify-center md:py-14">
      <div className="max-w-[1400px] h-full w-full flex flex-col items-center justify-center space-y-5 lg:space-y-10 text-white">
        <h1 className="text-5xl  lg:text-7xl  font-bold  text-center ">
          Find the <span className="text-primary"> best developers </span>{" "}
          <br />
          with us easily
        </h1>
...
/>
        ...
        <div className="hidden sm:flex space-x-2">
          <span className="font-medium">
            {" "}
            Top <span className="text-primary">Keywords</span>:
          </span>
          <div className="flex items-center space-x-2">
            {["Frontend", "Backend", "Mobile", "Embedded"].map(
              (value: string) => (
                <span
                  key={value}
                  className="text-white font-semibold cursor-pointer hover:text-primary transition-colors duration-300"
                >
                  {value}
                </span>
              )
