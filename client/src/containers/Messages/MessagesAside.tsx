  ...
  return (
    <div className='w-[35%]  h-full'>
          ...
          <div className='w-full max-w-[400px]  relative'>
            ...
            type="search" className='outline-none border-none bg-gray-100 rounded-full px-4 py-3 w-full ' />
            <FiSearch className={`absolute top-[50%] translate-y-[-50%] text-xl text-primary transition-all duration-700 ${translate ? 'left-[50%] ':'left-[90%]'} ${maskSearchIcon && 'hidden'}`}/> 
          </div>
